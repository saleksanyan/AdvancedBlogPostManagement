...
export class Migration1746385231779 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."blog_post_mood_enum" AS ENUM('sad', 'happy', 'excited', 'calm', 'angry')`);
        await queryRunner.query(`ALTER TABLE "blog_post" ADD "mood" "public"."blog_post_mood_enum" NOT NULL DEFAULT 'calm'`);
    }
